...
class ApplicationTest {
    ...
    @Test
    fun `get quotes with empty list`() = testApplication {
        application {
            install(ContentNegotiation) { json(json) }
    ...
    @Test
    fun `post single quote`() = testApplication {
        application { setup() }
    ...
    @Test
    fun `post multiple quotes`() = testApplication {
        application { setup() }
    ...
    @Test
    fun `post quote with malformed json`() = testApplication {
        application { setup() }
    ...
    @Test
    fun `delete a quote`() = testApplication {
        application { setup() }
    ...
    @Test
    fun `get quote by title`() = testApplication {
        application { setup() }
    ...
    @Test
    fun `get quote by title not found`() = testApplication {
        application { setup() }
    ...
    @Test
    fun `get quote by title when title is null`() = testApplication {
        application { setup() }
